...
const MedicalSection = () => {
    return (
        <>
            <section id="medical" className='min-h-screen max-container'>
                <div className='relative text-center text-[white]'>
                    <picture>
                        {/* image pour plus large que mobile */}
                        <source media="(min-width:1024px)" srcset={medical} />
                        <source media="(min-width:768px)" srcset={medical} />
                        {/* par defaut image pour mobile */}
                        <img src={medical} width="100%" className='h-full object-cover' />
                    </picture>
                    <div className='absolute -translate-x-2/4 -translate-y-2/4 left-2/4 top-2/4'>
                        <Typography className={`font-articulat_cf font-bold text-sm sm:text-3xl lg:text-5xl leading-none tracking-tight break-keep mb-3`}>
                            Exemple en milieu médical et hospitalier
                        </Typography>
                        <Typography className={`font-articulat_cf font-normal text-xs sm:text-xl lg:text-3xl leading-none tracking-tight break-keep`}>
                            ...
                            Ce qui complique la compréhension de la maladie et l'éducation thérapeutique de vos patients ne maîtrisant pas le français ?
                        </Typography>
                        <div>
                        </div>
                    </div>
            ...
            <section id="med_suite" className='min-h-screen max-container'>
