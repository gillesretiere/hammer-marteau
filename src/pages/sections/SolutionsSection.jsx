...
import { solution_001 } from '../../assets';
            ...
            <section id="solutions" className='min-h-screen max-container'>
                <div className='relative text-center text-[white]'>
                    <picture>
                        ...
                        <source media="(min-width:1024px)" srcset={solution_001} />
                        <source media="(min-width:768px)" srcset={solution_001} />
                        {/* par defaut image pour mobile */}
                        <img src={solution_001} width="100%" className='h-full object-cover' />
                    </picture>
